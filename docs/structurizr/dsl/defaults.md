 [Skip to main content](defaults.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
The DSL is designed to be as compact as possible. When used in conjunction with [Structurizr Lite](https://docs.structurizr.com/lite) or the [Structurizr CLI](https://docs.structurizr.com/cli), the following DSL fragment will automatically:

* Create the [implied relationship](https://docs.structurizr.com/java/implied-relationships) between the `user` and `softwareSystem` elements.
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/04-defaults.md)