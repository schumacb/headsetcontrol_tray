 [Skip to main content](language.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
* [Structurizr DSL](index.md)
  ...
  * [Cookbook](cookbook/index.md)
    ...
    * [Bulk operations - elements](cookbook/bulk-operations-elements.md)
...
* [workspace](language.md)
* [model](language.md)
* [enterprise](language.md)
* [group](language.md)
* [person](language.md)
* [softwareSystem](language.md)
* [container](language.md)
* [component](language.md)
* [deploymentEnvironment](language.md)
* [deploymentGroup](language.md)
* [deploymentNode](language.md)
* [infrastructureNode](language.md)
* [softwareSystemInstance](language.md)
* [containerInstance](language.md)
* [healthCheck](language.md)
* [element](language.md)
* [relationship](language.md)
* [tag](language.md)
* [tags](language.md)
* [description](language.md)
* [technology](language.md)
* [instances](language.md)
* [url](language.md)
* [properties](language.md)
* [perspectives](language.md)
* [!extend](language.md)
* [!ref](language.md)
* [!element](language.md)
* [!elements](language.md)
* [!relationship](language.md)
* [!relationships](language.md)
* [views](language.md)
* [systemLandscape view](language.md)
* [systemContext view](language.md)
* [container view](language.md)
* [component view](language.md)
* [filtered view](language.md)
* [dynamic view](language.md)
* [deployment view](language.md)
* [custom view](language.md)
* [image view](language.md)
* [include](language.md)
  * [Including elements](language.md)
  * [Including relationships](language.md)
* [exclude](language.md)
  * [Excluding elements](language.md)
  * [Excluding relationships](language.md)
* [autoLayout](language.md)
* [default](language.md)
* [animation](language.md)
* [title](language.md)
* [styles](language.md)
* [element style](language.md)
* [relationship style](language.md)
* [theme](language.md)
* [themes](language.md)
* [branding](language.md)
* [terminology](language.md)
* [configuration](language.md)
* [scope](language.md)
* [visibility](language.md)
* [users](language.md)
* [!include](language.md)
* [!identifiers](language.md)
* [!impliedRelationships](language.md)
* [!docs](language.md)
* [!adrs](language.md)
* [!components](language.md)
* [!script](language.md)
* [!plugin](language.md)
...
`workspace` is the top level language construct, and the wrapper for the [model](language.md) and [views](language.md). A workspace can optionally be given a name and description.
...
**This concept has been removed in v2.0 - please use [group](language.md) instead.**

## group

The `group` keyword provides a way to define a named grouping of elements, which will be rendered as a boundary around those elements. Groups can be nested; see [DSL Cookbook - Groups](cookbook/groups/index.md) for more information.
...
See [Structurizr - Help - Notation](https://docs.structurizr.com/ui/diagrams/notation) for a description of which groups are shown for a given diagram type.
...
* [properties](language.md)
* [perspectives](language.md)
* [group](language.md) (available from v4.0.0)
* [-> (relationship)](language.md)
...
* [group](language.md)
* [deploymentNode](language.md) (deployment nodes can be nested)
* [infrastructureNode](language.md)
* [softwareSystemInstance](language.md)
* [containerInstance](language.md)
* [-> (relationship)](language.md)
...
See [DSL cookbook - Custom elements](cookbook/custom-elements/index.md) for an example.
...
The `perspectives` block is used to define one or more named perspectives for an element or relationship. See [Help - Perspectives](https://docs.structurizr.com/ui/diagrams/perspectives) for how these are used.
...
The first usage scenario is to extend an existing element that has been defined via the DSL. See [DSL cookbook - Workspace extension](cookbook/workspace-extension/index.md) for a usage example.
...
The `!elements` keyword can be used to find a set of elements via an [element expression](expressions.md) in order to perform bulk operations on them.
...
The `!relationships` keyword can be used to find a set of relationships via a [relationship expression](expressions.md) in order to perform bulk operations on them.
...
* [systemLandscape](language.md)
* [systemContext](language.md)
* [container](language.md)
* [component](language.md)
* [filtered](language.md)
* [dynamic](language.md)
* [deployment](language.md)
* [custom](language.md)
* [image](language.md)
* [styles](language.md)
* [theme](language.md)
...
If a workspace doesn’t have a `views` block, or the `views` block doesn’t define any views, a [default set of views](language.md) will be defined for you. Defining one or more views in the `views` block will remove this default set of views, although they can be added back with a script if needed:
...
A view key will be generated for you if not specified; **automatically generated view keys are not guaranteed to be stable over time, and you will likely lose [manual layout information](https://docs.structurizr.com/ui/diagrams/manual-layout) when using them in conjunction with Structurizr Lite/on-premises/cloud**.
...
The `filtered` keyword is used to define a [filtered view](https://docs.structurizr.com/ui/diagrams/filtered-view) on top of the specified view.
...
See [DSL cookbook - Dynamic view](cookbook/dynamic-view/index.md) and [DSL cookbook - Dynamic view with parallel sequences](cookbook/dynamic-view-parallel/index.md) for examples.
...
The `custom` keyword is used to define a [custom view](https://docs.structurizr.com/ui/diagrams/custom-view). Only [custom elements](language.md) are permitted to be included on a custom view.
...
See [DSL cookbook - Custom view](cookbook/custom-view/index.md) for an example.
...
The `image` keyword is used to define an [image view](https://docs.structurizr.com/ui/diagrams/image-view) (this is only available on the Structurizr cloud service/on-premises installation/Lite).
...
The public PlantUML (`https://plantuml.com/plantuml`), Mermaid (`https://mermaid.ink`), and Kroki (`https://kroki.io`) URLs may work, but (1) please be aware that you are sending information to a third-party service and (2) these public services may not correctly set the CORS headers required for image views to work (see the notes at [Image views](https://docs.structurizr.com/ui/diagrams/image-view)).

See [DSL cookbook - Image view](cookbook/image-view/index.md) and the [image view tests](https://github.com/structurizr/java/tree/master/structurizr-dsl/src/test/resources/dsl/image-views) for some examples.
...
Elements can either be specified using individual identifiers, the wildcard identifier (`*`) or an [element expression](expressions.md). Please note that including elements will also include the relationships between those elements.
...
To exclude a relationship in a view, you can specify an individual relationship identifier or a [relationship expression](expressions.md):
...
Please note that if your DSL workspace does not explicitly define any views, the DSL parser will automatically create a default set of views for you, with auto-layout enabled. To change this behaviour, you can either (1) explicitly define your views or (2) use a script to disable automatic layout ([example](cookbook/scripts/index.md)).
...
* [DSL cookbook - Element styles](cookbook/element-styles/index.md)
* [DSL cookbook - Groups](cookbook/groups/index.md)
* [Structurizr - Notation](https://docs.structurizr.com/ui/diagrams/notation)

Notes:

* Colors can be specified as a hex code (e.g. `#ffff00`) or a CSS/HTML named color (e.g. `yellow`).
* See [Notation - Icons](https://docs.structurizr.com/ui/diagrams/notation#icons) for information about HTTPS/CORS if you are using the Structurizr cloud service/on-premises installation/Lite and specifying an element style icon via a URL.
* Element styles are designed to work with the Structurizr cloud service/on-premises installation/Lite, and may not be fully supported by the [PlantUML, Mermaid, etc export formats](https://docs.structurizr.com/export) (e.g. shapes and icons).
...
* [DSL cookbook - Relationship styles](cookbook/relationship-styles/index.md)
* [Structurizr - Notation](https://docs.structurizr.com/ui/diagrams/notation)

Notes:

* Colors can be specified as a hex code (e.g. `#ffff00`) or a CSS/HTML named color (e.g. `yellow`).
* Relationship styles are designed to work with the Structurizr cloud service/on-premises installation/Lite, and may not be fully supported by the [PlantUML, Mermaid, etc export formats](https://docs.structurizr.com/export) (e.g. line/arrow colours).

## theme

The `theme` keyword can be used to specify a theme that should be used when rendering diagrams. See [Themes](https://docs.structurizr.com/ui/diagrams/themes) for more details.
...
The `themes` keyword can be used to specify one or more themes that should be used when rendering diagrams. See [Themes](https://docs.structurizr.com/ui/diagrams/themes) for more details.
...
The `branding` keyword allows you to define some custom branding that should be used when rendering diagrams and documentation. See [Diagrams - Branding](https://docs.structurizr.com/ui/diagrams/branding) and [Documentation - Branding](https://docs.structurizr.com/ui/documentation/branding) for more details.
...
* See [Notation - Icons](https://docs.structurizr.com/ui/diagrams/notation#icons) for information about HTTPS/CORS if you are using the Structurizr cloud service/on-premises installation/Lite and specifying a branding icon via a URL.
...
See [Includes](includes.md) for more details.
...
See [Implied relationships](implied-relationships.md) for more details.
...
See [Architecture decision records](adrs.md) for more details.
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/71-language.md)