 [Skip to main content](docs.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
2. Markdown/Asciidoc documentation
...
By default, the [com.structurizr.importer.documentation.DefaultDocumentationImporter](https://github.com/structurizr/java/blob/master/structurizr-import/src/main/java/com/structurizr/importer/documentation/DefaultDocumentationImporter.java) class will be used to import documentation as follows:
...
* See [Structurizr - Documentation - Headings and sections](https://docs.structurizr.com/ui/documentation/headings) for details about how section headings and numbering are handled.
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/51-docs.md)