 [Skip to main content](example.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/01-example.md)