 [Skip to main content](scripts.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
Scripts are like plugins, except they don’t need to be compiled before use. JavaScript(\*), Kotlin, Groovy, and Ruby are supported out of the box, and you can add more languages via the Java Scripting API. Scripts can be used at any point in the DSL.
...
(\*) Nashorn (the JVM JavaScript engine) is deprecated, see <https://openjdk.java.net/jeps/372> for details.
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/61-scripts.md)