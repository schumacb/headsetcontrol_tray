...
An [image view](https://docs.structurizr.com/ui/diagrams/image-view) represents an image that has been rendered outside of Structurizr, for inclusion in a Structurizr workspace. Image views can be created from an arbitrary PNG/SVG file, or a PlantUML/Mermaid/Kroki diagram. An example use case for an image view is to provide a “level 4” zoom-in for a component on a component diagram.
...
[![](../../assets/dsl/cookbook/image-view/example-1.png)](http://structurizr.com/dsl?src=https://docs.structurizr.com/dsl/cookbook/image-view/example-1.dsl)

## Links

* [Image views](https://docs.structurizr.com/ui/diagrams/image-view)
* [DSL language reference - image](../../language/index.md)
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/cookbook/image-view/index.md)