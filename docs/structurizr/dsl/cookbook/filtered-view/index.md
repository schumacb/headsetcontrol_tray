...
A [filtered view](https://docs.structurizr.com/ui/diagrams/filtered-view) represents “a view on top of another view”, which can be used to filter (`include` or `exclude`) specific elements and/or relationships, based upon their tag. Consider the following workspace definition:
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/cookbook/filtered-view/index.md)