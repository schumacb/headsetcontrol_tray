...
A [deployment view](https://c4model.com/#DeploymentDiagram) allows you to show how software systems and containers are deployed, by showing the mapping of software system and container *instances* onto deployment nodes.
...
* [DSL language reference - deployment](../../language.md)
