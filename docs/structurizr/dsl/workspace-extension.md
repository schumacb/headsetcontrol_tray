 [Skip to main content](workspace-extension.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
The Structurizr DSL provides a way to extend an existing workspace, enabling you to reuse common elements/relationships across multiple workspaces.

## Links

* [DSL Cookbook - Workspace extension](cookbook/workspace-extension/index.md)
* [Usage - Enterprise](https://docs.structurizr.com/usage/enterprise)
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/32-workspace-extension.md)