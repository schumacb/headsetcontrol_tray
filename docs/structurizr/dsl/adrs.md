 [Skip to main content](adrs.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
See [Structurizr UI - Decisions](https://docs.structurizr.com/ui/decisions) for details of how ADRs are rendered with the Structurizr UI.
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/52-adrs.md)