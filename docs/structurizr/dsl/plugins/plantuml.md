 [Skip to main content](plantuml.md)   Link      Menu      Expand       (external link)    Document      Search       Copy       Copied
...
This Structurizr DSL plugin looks for inline PlantUML diagram definitions in Markdown/AsciiDoc documentation and decisions, and encodes them as images.
...
After [installation](../plugins.md), the plugin can be referenced from your DSL file as follows:
...
You will need to provide a PlantUML URL, and optionally a format (`png` or `svg`), when using this plugin. These can be specified as view set properties:
...
The public PlantUML URL (`https://plantuml.com/plantuml`) may work, but please be aware that you are sending information to a third-party service.
...
[Edit this page on GitHub.](https://github.com/structurizr/structurizr.github.io/tree/main/dsl/plugins/plantuml.md)