...
# Import HIDConnectionManager for type hinting if needed, or rely on HIDManagerInterface
...
def test_linux_impl_perform_device_setup_prepare_fails(linux_impl_fixture):
    linux_impl_fixture._udev_manager.create_rules_interactive.return_value = False  # Changed method name
...
def test_linux_impl_perform_device_setup_pkexec_success(linux_impl_fixture):  # mocker removed
    linux_impl_fixture._udev_manager.create_rules_interactive.return_value = True  # Changed method name
...
def test_linux_impl_perform_device_setup_exceptions(
    ...
    def test_linux_impl_internal_execute_helper_script_calls_subprocess_run(linux_impl_fixture):
        ...
        with (
            ...
            mock_file_dunder_path_obj.parent = MagicMock() # Removed spec=Path
            # Path(__file__).parent.parent
            mock_file_dunder_path_obj.parent.parent = MagicMock() # Removed spec=Path
            ...
            scripts_dir_mock.resolve.return_value = scripts_dir_mock  # .resolve() # type: ignore
            ...
            def path_side_effect(value):
                ...
                generic_path_mock.is_file = MagicMock(return_value=True)  # Ensure is_file is a mock # type: ignore
