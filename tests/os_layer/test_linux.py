...
def linux_impl_fixture(): # mocker removed
    ...
    with patch("headsetcontrol_tray.os_layer.linux.UDEVManager", autospec=True) as mock_udev_manager_class, \
         patch("headsetcontrol_tray.os_layer.linux.HIDConnectionManager", autospec=True) as mock_hid_manager_class: # Patched HIDConnectionManager
