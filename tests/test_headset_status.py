...
class TestHeadsetStatusParser(unittest.TestCase): # Removed class decorator
    def setUp(self): # Signature changed
        self.logger_patcher = patch(f'{HeadsetStatusParser.__module__}.logger', new_callable=MagicMock)
    ...
    def test_parse_status_report_online_charging_full_battery_mid_chatmix(self): # Removed mock_logger arg
    ...
    def test_parse_status_report_various_battery_levels(self): # Removed mock_logger arg
...
class TestHeadsetCommandEncoder(unittest.TestCase): # Removed class decorator
    def setUp(self): # Signature changed
        self.logger_patcher = patch(f'{HeadsetCommandEncoder.__module__}.logger', new_callable=MagicMock)
        self.mock_logger = self.logger_patcher.start()
        self.addCleanup(self.logger_patcher.stop)
