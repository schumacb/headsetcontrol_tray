...
class ConfigManager:
    ...
    def get_custom_eq_curve(self, name: str) -> Optional[List[int]]:
    ...
    def get_last_custom_eq_curve_name(self) -> str:
        ...
        elif name not in self._custom_eq_curves and self._custom_eq_curves: # fallback to first available if default also gone
