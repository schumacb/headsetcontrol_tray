...
"""
        ...
        if clicked_button_role == auto_button:
            ...
            temp_file_path = udev_details["temp_file_path"] # Use udev_details consistently
            final_file_path = udev_details["final_file_path"] # Use udev_details consistently
            ...
            if not os.path.exists(helper_script_path):
                ...
                try:
                    ...
                    QMessageBox.critical(None, "Error", "pkexec command not found.\nPlease ensure PolicyKit is correctly installed and configured.") # type: ignore [arg-type]
